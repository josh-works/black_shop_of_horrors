...
organ = Category.create!(title: "Organs", image: "http://theamishworkshop.com/uploads/7/5/1/2/75128337/fanbackcombo_orig.jpg")
...
organ.items.create!(title: "Heart",
            ...
            price: 25499,
            image: "http://www.scienco.uk/files/2016/10/sn-pigheart.jpg"
            )
organ.items.create!(title: "Liver",
            description: "All of our hearts will eventually wear out. Why let yours?",
            price: 34,
            image: "http://www.sciencemadesim6/10/sn-pigheart.jpg"
            )
organ.items.create!(title: "Brain",
            description: "All of our hearts will eventually wear out. Why let yours?",
            price: 25234499,
            image: "http://www.sciencemadesimple.co.uk/files/2gheart.jpg"
            )
