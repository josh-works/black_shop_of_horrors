...
RSpec.feature "When a user visits category parent path, they see a list of
 ...
 before(:each) do
   ...
   organs.items.create!(title: "Liver", price: 350,image: "https://ichef-1.bbci.co.uk/news/1024/media/images/73793000/jpg/_73793871_liver.jpg")
   organs.items.create!(title: "Small Intestines", price: 450, image: "http://img.clipartall.com/illustration-of-a-small-small-intestine-clipart-1094_1300.jpg")
   organs.items.create!(title: "Heart", price: 1000, image: "http://www.sciencemadesimple.co.uk/files/2016/10/sn-pigheart.jpg")
  end
